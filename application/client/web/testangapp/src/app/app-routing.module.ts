...
{ path : 'employeeinsert', loadChildren: () => import('./employeeinsert/employeeinsert.module').then(m => m.EmployeeinsertModule), canActivate: [AuthGuard] } , 
{ path : 'employeelist', loadChildren: () => import('./employeelist/employeelist.module').then(m => m.EmployeelistModule), canActivate: [AuthGuard] } , 
];
